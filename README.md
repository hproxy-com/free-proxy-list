<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1782070616" alt="HProxy Free Proxy List" width="560"></a>
</p>
...
<p align="center">
  ...
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Proxies-23,503-006039?style=for-the-badge&labelColor=1A1918" alt="Proxies"></a>
...
<p align="center"><b>The biggest free proxy list, continuously scanned 24/7.</b><br>23,503 HTTP, HTTPS, SOCKS4 and SOCKS5 proxies, 3,512 verified live right now, refreshed every 2 minutes, with country, anonymity and latency on every IP.</p>
<p align="center"><sub>Updated 21.06.2026, 292,426+ tracked all-time</sub></p>

## Download

| List | Proxies | Formats |
|------|--------:|---------|
| **All** | 23,503 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 2,373 | [txt](http.txt) |
| HTTPS | 1,190 | [txt](https.txt) |
| SOCKS4 | 1,364 | [txt](socks4.txt) |
| SOCKS5 | 1,391 | [txt](socks5.txt) |
| Iran (IR) | 5,594 | [txt](by-country/IR.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| Iran (IR) | 5,594 | [by-country/IR.txt](by-country/IR.txt) |
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; auto-updated every 2 minutes &nbsp;&middot;&nbsp; 2026-06-21 19:36 UTC</sub></p>
