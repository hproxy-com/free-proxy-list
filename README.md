<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1787813439" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-666,555-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-39,475-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **666,555 proxies tracked all-time**, with **39,475** live and working in the pool right now. It is completely free, updated continuously, and needs no signup and no API key.
...
- **666,555** proxies tracked all-time, **39,475** live right now
...
|------|--------:|---------|
| **All** | 39,475 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 3,196 | [txt](http.txt) |
| HTTPS | 2,278 | [txt](https.txt) |
| SOCKS4 | 2,309 | [txt](socks4.txt) |
| SOCKS5 | 2,054 | [txt](socks5.txt) |
| Elite (high-anonymity) | 4,090 | [txt](elite.txt) |
| Anonymous | 395 | [txt](anonymous.txt) |
| Fast (under 2s) | 2,369 | [txt](fast.txt) |
| United States (US) | 6,887 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 6,887 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,385 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 2,643 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,587 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,043 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 1,952 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 1,397 | [by-country/HK.txt](by-country/HK.txt) |
| Canada (CA) | 1,364 | [by-country/CA.txt](by-country/CA.txt) |
| France (FR) | 1,294 | [by-country/FR.txt](by-country/FR.txt) |
| South Korea (KR) | 1,285 | [by-country/KR.txt](by-country/KR.txt) |
| Thailand (TH) | 1,212 | [by-country/TH.txt](by-country/TH.txt) |
| South Africa (ZA) | 1,136 | [by-country/ZA.txt](by-country/ZA.txt) |
...
Over 666,555 have been tracked all-time, and 39,475 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-27 06:50 UTC</sub></p>
