<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1782069375" alt="HProxy Free Proxy List" width="560"></a>
</p>
...
<p align="center">
  ...
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Proxies-23,728-006039?style=for-the-badge&labelColor=1A1918" alt="Proxies"></a>
...
<p align="center"><b>The biggest free proxy list, continuously scanned 24/7.</b><br>23,728 HTTP, HTTPS, SOCKS4 and SOCKS5 proxies, 3,192 verified live right now, refreshed every 2 minutes, with country, anonymity and latency on every IP.</p>
...
|------|--------:|---------|
| **All** | 23,728 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 2,188 | [txt](http.txt) |
| HTTPS | 1,030 | [txt](https.txt) |
| SOCKS4 | 1,307 | [txt](socks4.txt) |
| SOCKS5 | 1,217 | [txt](socks5.txt) |
| Iran (IR) | 5,689 | [txt](by-country/IR.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| Iran (IR) | 5,689 | [by-country/IR.txt](by-country/IR.txt) |
| Indonesia (ID) | 2,801 | [by-country/ID.txt](by-country/ID.txt) |
| United States (US) | 1,632 | [by-country/US.txt](by-country/US.txt) |
| China (CN) | 1,456 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 901 | [by-country/IN.txt](by-country/IN.txt) |
...
| Philippines (PH) | 447 | [by-country/PH.txt](by-country/PH.txt) |
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; auto-updated every 2 minutes &nbsp;&middot;&nbsp; 2026-06-21 19:16 UTC</sub></p>
