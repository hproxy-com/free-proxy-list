<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1782068755" alt="HProxy Free Proxy List" width="560"></a>
</p>
...
<p align="center">
  ...
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Proxies-23,449-006039?style=for-the-badge&labelColor=1A1918" alt="Proxies"></a>
...
<p align="center"><b>The biggest free proxy list, continuously scanned 24/7.</b><br>23,449 HTTP, HTTPS, SOCKS4 and SOCKS5 proxies, 3,549 verified live right now, refreshed every 2 minutes, with country, anonymity and latency on every IP.</p>
<p align="center"><sub>Updated 21.06.2026, 292,474+ tracked all-time</sub></p>

## Download

| List | Proxies | Formats |
|------|--------:|---------|
| **All** | 23,449 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 2,467 | [txt](http.txt) |
| HTTPS | 1,216 | [txt](https.txt) |
| SOCKS4 | 1,445 | [txt](socks4.txt) |
| SOCKS5 | 1,423 | [txt](socks5.txt) |
| Iran (IR) | 5,604 | [txt](by-country/IR.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| Iran (IR) | 5,604 | [by-country/IR.txt](by-country/IR.txt) |
| Indonesia (ID) | 2,774 | [by-country/ID.txt](by-country/ID.txt) |
| United States (US) | 1,622 | [by-country/US.txt](by-country/US.txt) |
| China (CN) | 1,429 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 888 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 690 | [by-country/JP.txt](by-country/JP.txt) |
| Germany (DE) | 671 | [by-country/DE.txt](by-country/DE.txt) |
| Hong Kong (HK) | 632 | [by-country/HK.txt](by-country/HK.txt) |
| South Korea (KR) | 612 | [by-country/KR.txt](by-country/KR.txt) |
| Russia (RU) | 486 | [by-country/RU.txt](by-country/RU.txt) |
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; auto-updated every 2 minutes &nbsp;&middot;&nbsp; 2026-06-21 19:05 UTC</sub></p>
