<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788223441" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-721,534-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-74,040-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
<p align="center"><sub>HTTP, HTTPS, SOCKS4 and SOCKS5 &middot; country, anonymity, latency and uptime on every IP &middot; updated 01.09.2026</sub></p>

HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **721,534 proxies tracked all-time**, with **11,892** live right now and **74,040** working in the last 48h. Both are published: take `live.txt` if every entry must be up this second, `all.txt` if you want the wider pool that free proxies revive into. It is completely free, updated continuously, and needs no signup and no API key.
...
- **721,534** proxies tracked all-time, **74,040** working in the last 48h
...
|------|--------:|---------|
| **Live now** | 11,892 | [txt](live.txt) &middot; [json](live.json) &middot; [csv](live.csv) |
| **All** (working in 48h) | 74,040 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 5,435 | [txt](http.txt) |
| HTTPS | 3,548 | [txt](https.txt) |
| SOCKS4 | 3,544 | [txt](socks4.txt) |
| SOCKS5 | 6,200 | [txt](socks5.txt) |
| Elite (high-anonymity) | 8,267 | [txt](elite.txt) |
| Anonymous | 1,058 | [txt](anonymous.txt) |
| Fast (under 2s) | 6,616 | [txt](fast.txt) |
| United States (US) | 32,170 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
<details>
<summary><b>Free proxies by country</b> (135 countries)</summary>

| Country | Proxies | File |
|---------|--------:|------|
| United States (US) | 32,170 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 4,119 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 3,655 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,787 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,693 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,576 | [by-country/AU.txt](by-country/AU.txt) |
| Canada (CA) | 1,914 | [by-country/CA.txt](by-country/CA.txt) |
| Hong Kong (HK) | 1,884 | [by-country/HK.txt](by-country/HK.txt) |
| South Korea (KR) | 1,685 | [by-country/KR.txt](by-country/KR.txt) |
| France (FR) | 1,639 | [by-country/FR.txt](by-country/FR.txt) |
| Thailand (TH) | 1,518 | [by-country/TH.txt](by-country/TH.txt) |
| South Africa (ZA) | 1,488 | [by-country/ZA.txt](by-country/ZA.txt) |
| _+123 more countries_ | | [full by-country/ folder &raquo;](by-country) |
...
Over 721,534 have been tracked all-time, and 74,040 were working within the last 48h. The published files hold exactly those proxies.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-09-01 00:44 UTC</sub></p>
