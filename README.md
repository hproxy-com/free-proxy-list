<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1784139929" alt="HProxy Free Proxy List" width="560"></a>
</p>
...
<p align="center"><b>The biggest free proxy list, continuously scanned 24/7.</b><br>562,258 proxies tracked all-time, 26,179 in the live working pool (alive within 48h).</p>
...
| HTTP | 2,951 | [txt](http.txt) |
| HTTPS | 1,535 | [txt](https.txt) |
| SOCKS4 | 1,169 | [txt](socks4.txt) |
| SOCKS5 | 1,172 | [txt](socks5.txt) |
| Iran (IR) | 6,436 | [txt](by-country/IR.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| Iran (IR) | 6,436 | [by-country/IR.txt](by-country/IR.txt) |
| Indonesia (ID) | 2,345 | [by-country/ID.txt](by-country/ID.txt) |
| United States (US) | 1,695 | [by-country/US.txt](by-country/US.txt) |
| China (CN) | 1,621 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 1,295 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 941 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 851 | [by-country/AU.txt](by-country/AU.txt) |
| South Korea (KR) | 721 | [by-country/KR.txt](by-country/KR.txt) |
| Hong Kong (HK) | 653 | [by-country/HK.txt](by-country/HK.txt) |
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-07-15 18:25 UTC</sub></p>
