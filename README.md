<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788173119" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-720,007-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-59,502-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **720,007 proxies tracked all-time**, with **59,502** working in the last 48h. It is completely free, updated continuously, and needs no signup and no API key.
...
- **720,007** proxies tracked all-time, **59,502** working in the last 48h
...
|------|--------:|---------|
| **All** | 59,502 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 6,629 | [txt](http.txt) |
| HTTPS | 3,469 | [txt](https.txt) |
| SOCKS4 | 3,219 | [txt](socks4.txt) |
| SOCKS5 | 5,278 | [txt](socks5.txt) |
| Elite (high-anonymity) | 9,698 | [txt](elite.txt) |
| Anonymous | 626 | [txt](anonymous.txt) |
| Fast (under 2s) | 5,669 | [txt](fast.txt) |
| United States (US) | 24,417 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 24,417 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,531 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 3,127 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,307 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,233 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,131 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 1,586 | [by-country/HK.txt](by-country/HK.txt) |
| Canada (CA) | 1,537 | [by-country/CA.txt](by-country/CA.txt) |
| South Korea (KR) | 1,396 | [by-country/KR.txt](by-country/KR.txt) |
| France (FR) | 1,363 | [by-country/FR.txt](by-country/FR.txt) |
| Thailand (TH) | 1,260 | [by-country/TH.txt](by-country/TH.txt) |
| South Africa (ZA) | 1,241 | [by-country/ZA.txt](by-country/ZA.txt) |
...
Over 720,007 have been tracked all-time, and 59,502 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-31 10:45 UTC</sub></p>
