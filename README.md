<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788405390" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-754,427-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-65,715-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
<p align="center"><sub>HTTP, HTTPS, SOCKS4 and SOCKS5 &middot; country, anonymity, latency and uptime on every IP &middot; updated 03.09.2026</sub></p>

HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **754,427 proxies tracked all-time**, with **15,493** live right now and **65,715** working in the last 48h. Both are published: take `live.txt` if every entry must be up this second, `all.txt` if you want the wider pool that free proxies revive into. It is completely free, updated continuously, and needs no signup and no API key.
...
- **754,427** proxies tracked all-time, **65,715** working in the last 48h
...
|------|--------:|---------|
| **Live now** | 15,493 | [txt](live.txt) &middot; [json](live.json) &middot; [csv](live.csv) |
| **All** (working in 48h) | 65,715 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 7,560 | [txt](http.txt) |
| HTTPS | 4,801 | [txt](https.txt) |
| SOCKS4 | 4,283 | [txt](socks4.txt) |
| SOCKS5 | 7,428 | [txt](socks5.txt) |
| Elite (high-anonymity) | 11,317 | [txt](elite.txt) |
| Anonymous | 946 | [txt](anonymous.txt) |
| Fast (under 2s) | 8,242 | [txt](fast.txt) |
| United States (US) | 22,461 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 22,461 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 4,273 | [by-country/ID.txt](by-country/ID.txt) |
| India (IN) | 2,908 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,849 | [by-country/JP.txt](by-country/JP.txt) |
| China (CN) | 2,778 | [by-country/CN.txt](by-country/CN.txt) |
| Australia (AU) | 2,757 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 2,003 | [by-country/HK.txt](by-country/HK.txt) |
| Canada (CA) | 1,934 | [by-country/CA.txt](by-country/CA.txt) |
| South Korea (KR) | 1,816 | [by-country/KR.txt](by-country/KR.txt) |
| France (FR) | 1,757 | [by-country/FR.txt](by-country/FR.txt) |
| South Africa (ZA) | 1,592 | [by-country/ZA.txt](by-country/ZA.txt) |
| Thailand (TH) | 1,591 | [by-country/TH.txt](by-country/TH.txt) |
...
Over 754,427 have been tracked all-time, and 65,715 were working within the last 48h. The published files hold exactly those proxies.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-09-03 03:16 UTC</sub></p>
