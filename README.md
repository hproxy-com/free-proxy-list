<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788025529" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-672,392-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-43,162-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
<p align="center"><sub>HTTP, HTTPS, SOCKS4 and SOCKS5 &middot; country, anonymity, latency and uptime on every IP &middot; updated 29.08.2026</sub></p>

HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **672,392 proxies tracked all-time**, with **43,162** live and working in the pool right now. It is completely free, updated continuously, and needs no signup and no API key.
...
- **672,392** proxies tracked all-time, **43,162** live right now
...
|------|--------:|---------|
| **All** | 43,162 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 3,051 | [txt](http.txt) |
| HTTPS | 2,466 | [txt](https.txt) |
| SOCKS4 | 2,369 | [txt](socks4.txt) |
| SOCKS5 | 3,347 | [txt](socks5.txt) |
| Elite (high-anonymity) | 5,480 | [txt](elite.txt) |
| Anonymous | 268 | [txt](anonymous.txt) |
| Fast (under 2s) | 3,954 | [txt](fast.txt) |
| United States (US) | 8,425 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 8,425 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,557 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 2,921 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,307 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,273 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,097 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 1,529 | [by-country/HK.txt](by-country/HK.txt) |
| Canada (CA) | 1,517 | [by-country/CA.txt](by-country/CA.txt) |
| South Korea (KR) | 1,418 | [by-country/KR.txt](by-country/KR.txt) |
| France (FR) | 1,403 | [by-country/FR.txt](by-country/FR.txt) |
| Thailand (TH) | 1,276 | [by-country/TH.txt](by-country/TH.txt) |
| South Africa (ZA) | 1,219 | [by-country/ZA.txt](by-country/ZA.txt) |
...
Over 672,392 have been tracked all-time, and 43,162 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-29 17:45 UTC</sub></p>
