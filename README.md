<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1782067395" alt="HProxy Free Proxy List" width="560"></a>
</p>
...
<p align="center"><b>The biggest free proxy list, continuously scanned 24/7. 23,551 live &amp; recently-checked proxies, refreshed every 2 minutes.</b><br>HTTP, HTTPS, SOCKS4 and SOCKS5, with country, anonymity and latency on every IP. 3,366 live right now, 288,712+ tracked all-time, updated 21.06.2026.</p>

## Download

| List | Proxies | Formats |
|------|--------:|---------|
| All | 23,551 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 2,311 | [txt](http.txt) |
| HTTPS | 1,100 | [txt](https.txt) |
| SOCKS4 | 1,290 | [txt](socks4.txt) |
| SOCKS5 | 1,281 | [txt](socks5.txt) |
...
|---------|--------:|------|
| Iran (IR) | 5,799 | [by-country/IR.txt](by-country/IR.txt) |
| Indonesia (ID) | 2,708 | [by-country/ID.txt](by-country/ID.txt) |
| United States (US) | 1,618 | [by-country/US.txt](by-country/US.txt) |
| China (CN) | 1,423 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 895 | [by-country/IN.txt](by-country/IN.txt) |
...
| Bangladesh (BD) | 326 | [by-country/BD.txt](by-country/BD.txt) |
| Canada (CA) | 316 | [by-country/CA.txt](by-country/CA.txt) |
| United Kingdom (GB) | 297 | [by-country/GB.txt](by-country/GB.txt) |
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; auto-updated every 2 minutes &nbsp;&middot;&nbsp; 2026-06-21 18:43 UTC</sub></p>
