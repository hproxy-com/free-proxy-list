<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788144694" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-718,963-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-59,664-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **718,963 proxies tracked all-time**, with **59,664** live and working in the pool right now. It is completely free, updated continuously, and needs no signup and no API key.
...
- **718,963** proxies tracked all-time, **59,664** live right now
...
|------|--------:|---------|
| **All** | 59,664 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 10,246 | [txt](http.txt) |
| HTTPS | 3,893 | [txt](https.txt) |
| SOCKS4 | 3,049 | [txt](socks4.txt) |
| SOCKS5 | 4,978 | [txt](socks5.txt) |
| Elite (high-anonymity) | 11,791 | [txt](elite.txt) |
| Anonymous | 1,079 | [txt](anonymous.txt) |
| Fast (under 2s) | 5,736 | [txt](fast.txt) |
| United States (US) | 24,591 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 24,591 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,461 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 3,088 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,372 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,260 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,123 | [by-country/AU.txt](by-country/AU.txt) |
| Canada (CA) | 1,585 | [by-country/CA.txt](by-country/CA.txt) |
| Hong Kong (HK) | 1,579 | [by-country/HK.txt](by-country/HK.txt) |
| South Korea (KR) | 1,411 | [by-country/KR.txt](by-country/KR.txt) |
| France (FR) | 1,348 | [by-country/FR.txt](by-country/FR.txt) |
| Thailand (TH) | 1,275 | [by-country/TH.txt](by-country/TH.txt) |
| South Africa (ZA) | 1,244 | [by-country/ZA.txt](by-country/ZA.txt) |
| _+118 more countries_ | | [full by-country/ folder &raquo;](by-country) |
...
Over 718,963 have been tracked all-time, and 59,664 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-31 02:51 UTC</sub></p>
