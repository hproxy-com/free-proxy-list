<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788017026" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-672,157-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-42,912-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **672,157 proxies tracked all-time**, with **42,912** live and working in the pool right now. It is completely free, updated continuously, and needs no signup and no API key.
...
- **672,157** proxies tracked all-time, **42,912** live right now
...
|------|--------:|---------|
| **All** | 42,912 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 2,063 | [txt](http.txt) |
| HTTPS | 2,049 | [txt](https.txt) |
| SOCKS4 | 2,368 | [txt](socks4.txt) |
| SOCKS5 | 3,149 | [txt](socks5.txt) |
| Elite (high-anonymity) | 4,981 | [txt](elite.txt) |
| Anonymous | 198 | [txt](anonymous.txt) |
| Fast (under 2s) | 3,797 | [txt](fast.txt) |
| United States (US) | 8,087 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 8,087 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,557 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 2,900 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,352 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,238 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,119 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 1,550 | [by-country/HK.txt](by-country/HK.txt) |
| Canada (CA) | 1,535 | [by-country/CA.txt](by-country/CA.txt) |
| South Korea (KR) | 1,393 | [by-country/KR.txt](by-country/KR.txt) |
| France (FR) | 1,380 | [by-country/FR.txt](by-country/FR.txt) |
| Thailand (TH) | 1,269 | [by-country/TH.txt](by-country/TH.txt) |
| South Africa (ZA) | 1,228 | [by-country/ZA.txt](by-country/ZA.txt) |
...
Over 672,157 have been tracked all-time, and 42,912 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-29 15:23 UTC</sub></p>
