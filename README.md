<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1787966175" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-670,591-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-42,034-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **670,591 proxies tracked all-time**, with **42,034** live and working in the pool right now. It is completely free, updated continuously, and needs no signup and no API key.
...
- **670,591** proxies tracked all-time, **42,034** live right now
...
|------|--------:|---------|
| **All** | 42,034 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 3,107 | [txt](http.txt) |
| HTTPS | 2,672 | [txt](https.txt) |
| SOCKS4 | 2,707 | [txt](socks4.txt) |
| SOCKS5 | 3,248 | [txt](socks5.txt) |
| Elite (high-anonymity) | 4,408 | [txt](elite.txt) |
| Anonymous | 682 | [txt](anonymous.txt) |
| Fast (under 2s) | 3,930 | [txt](fast.txt) |
| United States (US) | 7,990 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 7,990 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,497 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 2,832 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,269 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,201 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,052 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 1,506 | [by-country/HK.txt](by-country/HK.txt) |
| Canada (CA) | 1,499 | [by-country/CA.txt](by-country/CA.txt) |
| South Korea (KR) | 1,353 | [by-country/KR.txt](by-country/KR.txt) |
| France (FR) | 1,343 | [by-country/FR.txt](by-country/FR.txt) |
...
Over 670,591 have been tracked all-time, and 42,034 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-29 01:16 UTC</sub></p>
