<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788076178" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-697,793-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-49,670-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **697,793 proxies tracked all-time**, with **49,670** live and working in the pool right now. It is completely free, updated continuously, and needs no signup and no API key.
...
- **697,793** proxies tracked all-time, **49,670** live right now
...
|------|--------:|---------|
| **All** | 49,670 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 6,376 | [txt](http.txt) |
| HTTPS | 3,132 | [txt](https.txt) |
| SOCKS4 | 2,844 | [txt](socks4.txt) |
| SOCKS5 | 6,311 | [txt](socks5.txt) |
| Elite (high-anonymity) | 11,217 | [txt](elite.txt) |
| Anonymous | 352 | [txt](anonymous.txt) |
| Fast (under 2s) | 6,437 | [txt](fast.txt) |
| United States (US) | 16,439 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 16,439 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,286 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 2,932 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,249 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,158 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,039 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 1,495 | [by-country/HK.txt](by-country/HK.txt) |
| Canada (CA) | 1,484 | [by-country/CA.txt](by-country/CA.txt) |
| France (FR) | 1,349 | [by-country/FR.txt](by-country/FR.txt) |
| South Korea (KR) | 1,319 | [by-country/KR.txt](by-country/KR.txt) |
| South Africa (ZA) | 1,203 | [by-country/ZA.txt](by-country/ZA.txt) |
| Thailand (TH) | 1,192 | [by-country/TH.txt](by-country/TH.txt) |
| _+122 more countries_ | | [full by-country/ folder &raquo;](by-country) |
...
Over 697,793 have been tracked all-time, and 49,670 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-30 07:49 UTC</sub></p>
