<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1787889466" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-669,199-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-41,827-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **669,199 proxies tracked all-time**, with **41,827** live and working in the pool right now. It is completely free, updated continuously, and needs no signup and no API key.
...
- **669,199** proxies tracked all-time, **41,827** live right now
...
|------|--------:|---------|
| **All** | 41,827 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 2,709 | [txt](http.txt) |
| HTTPS | 2,355 | [txt](https.txt) |
| SOCKS4 | 2,612 | [txt](socks4.txt) |
| SOCKS5 | 2,326 | [txt](socks5.txt) |
| Elite (high-anonymity) | 3,795 | [txt](elite.txt) |
| Anonymous | 560 | [txt](anonymous.txt) |
| Fast (under 2s) | 3,222 | [txt](fast.txt) |
| United States (US) | 7,767 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 7,767 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,405 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 2,806 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,702 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,182 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,088 | [by-country/AU.txt](by-country/AU.txt) |
| Canada (CA) | 1,455 | [by-country/CA.txt](by-country/CA.txt) |
| Hong Kong (HK) | 1,449 | [by-country/HK.txt](by-country/HK.txt) |
| France (FR) | 1,342 | [by-country/FR.txt](by-country/FR.txt) |
| South Korea (KR) | 1,330 | [by-country/KR.txt](by-country/KR.txt) |
| Thailand (TH) | 1,246 | [by-country/TH.txt](by-country/TH.txt) |
| South Africa (ZA) | 1,201 | [by-country/ZA.txt](by-country/ZA.txt) |
...
Over 669,199 have been tracked all-time, and 41,827 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-28 03:57 UTC</sub></p>
