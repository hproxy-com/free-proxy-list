<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788117914" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-698,762-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-54,408-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **698,762 proxies tracked all-time**, with **54,408** live and working in the pool right now. It is completely free, updated continuously, and needs no signup and no API key.
...
- **698,762** proxies tracked all-time, **54,408** live right now
...
|------|--------:|---------|
| **All** | 54,408 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 7,216 | [txt](http.txt) |
| HTTPS | 3,502 | [txt](https.txt) |
| SOCKS4 | 3,518 | [txt](socks4.txt) |
| SOCKS5 | 8,361 | [txt](socks5.txt) |
| Elite (high-anonymity) | 11,763 | [txt](elite.txt) |
| Anonymous | 1,335 | [txt](anonymous.txt) |
| Fast (under 2s) | 8,137 | [txt](fast.txt) |
| United States (US) | 20,043 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 20,043 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,440 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 3,034 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,267 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,227 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,117 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 1,551 | [by-country/HK.txt](by-country/HK.txt) |
| Canada (CA) | 1,516 | [by-country/CA.txt](by-country/CA.txt) |
| South Korea (KR) | 1,391 | [by-country/KR.txt](by-country/KR.txt) |
| France (FR) | 1,331 | [by-country/FR.txt](by-country/FR.txt) |
| Thailand (TH) | 1,292 | [by-country/TH.txt](by-country/TH.txt) |
| South Africa (ZA) | 1,231 | [by-country/ZA.txt](by-country/ZA.txt) |
...
Over 698,762 have been tracked all-time, and 54,408 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-30 19:25 UTC</sub></p>
