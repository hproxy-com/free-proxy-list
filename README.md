<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1787781618" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-664,122-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-36,274-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **664,122 proxies tracked all-time**, with **36,274** live and working in the pool right now. It is completely free, updated continuously, and needs no signup and no API key.
...
- **664,122** proxies tracked all-time, **36,274** live right now
...
|------|--------:|---------|
| **All** | 36,274 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 4,198 | [txt](http.txt) |
| HTTPS | 2,921 | [txt](https.txt) |
| SOCKS4 | 2,598 | [txt](socks4.txt) |
| SOCKS5 | 2,069 | [txt](socks5.txt) |
| Elite (high-anonymity) | 4,590 | [txt](elite.txt) |
| Anonymous | 470 | [txt](anonymous.txt) |
| Fast (under 2s) | 2,799 | [txt](fast.txt) |
| United States (US) | 4,708 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 4,708 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,482 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 2,616 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,448 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 1,921 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 1,817 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 1,291 | [by-country/HK.txt](by-country/HK.txt) |
| Canada (CA) | 1,237 | [by-country/CA.txt](by-country/CA.txt) |
| South Korea (KR) | 1,204 | [by-country/KR.txt](by-country/KR.txt) |
| France (FR) | 1,195 | [by-country/FR.txt](by-country/FR.txt) |
| Thailand (TH) | 1,118 | [by-country/TH.txt](by-country/TH.txt) |
...
Over 664,122 have been tracked all-time, and 36,274 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-26 22:00 UTC</sub></p>
