<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788578846" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-762,582-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-67,706-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
<p align="center"><sub>HTTP, HTTPS, SOCKS4 and SOCKS5 &middot; country, anonymity, latency and uptime on every IP &middot; updated 05.09.2026</sub></p>

HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **762,582 proxies tracked all-time**, with **10,150** live right now and **67,706** working in the last 48h. Both are published: take `live.txt` if every entry must be up this second, `all.txt` if you want the wider pool that free proxies revive into. It is completely free, updated continuously, and needs no signup and no API key.
...
- **762,582** proxies tracked all-time, **67,706** working in the last 48h
...
|------|--------:|---------|
| **Live now** | 10,150 | [txt](live.txt) &middot; [json](live.json) &middot; [csv](live.csv) |
| **All** (working in 48h) | 67,706 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 3,880 | [txt](http.txt) |
| HTTPS | 2,706 | [txt](https.txt) |
| SOCKS4 | 2,950 | [txt](socks4.txt) |
| SOCKS5 | 5,603 | [txt](socks5.txt) |
| Elite (high-anonymity) | 7,983 | [txt](elite.txt) |
| Anonymous | 517 | [txt](anonymous.txt) |
| Fast (under 2s) | 5,902 | [txt](fast.txt) |
| United States (US) | 22,941 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 22,941 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 4,406 | [by-country/ID.txt](by-country/ID.txt) |
| India (IN) | 3,003 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,961 | [by-country/JP.txt](by-country/JP.txt) |
| China (CN) | 2,753 | [by-country/CN.txt](by-country/CN.txt) |
| Australia (AU) | 2,721 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 2,131 | [by-country/HK.txt](by-country/HK.txt) |
| South Korea (KR) | 1,925 | [by-country/KR.txt](by-country/KR.txt) |
| Canada (CA) | 1,913 | [by-country/CA.txt](by-country/CA.txt) |
| France (FR) | 1,827 | [by-country/FR.txt](by-country/FR.txt) |
| Thailand (TH) | 1,668 | [by-country/TH.txt](by-country/TH.txt) |
| Germany (DE) | 1,655 | [by-country/DE.txt](by-country/DE.txt) |
...
Over 762,582 have been tracked all-time, and 67,706 were working within the last 48h. The published files hold exactly those proxies.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-09-05 03:27 UTC</sub></p>
