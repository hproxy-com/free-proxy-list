<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788153064" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-719,313-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-59,575-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **719,313 proxies tracked all-time**, with **59,575** live and working in the pool right now. It is completely free, updated continuously, and needs no signup and no API key.
...
- **719,313** proxies tracked all-time, **59,575** live right now
...
|------|--------:|---------|
| **All** | 59,575 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 7,133 | [txt](http.txt) |
| HTTPS | 2,931 | [txt](https.txt) |
| SOCKS4 | 2,480 | [txt](socks4.txt) |
| SOCKS5 | 4,386 | [txt](socks5.txt) |
| Elite (high-anonymity) | 8,603 | [txt](elite.txt) |
| Anonymous | 830 | [txt](anonymous.txt) |
| Fast (under 2s) | 5,111 | [txt](fast.txt) |
| United States (US) | 24,346 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
|---------|--------:|------|
| United States (US) | 24,346 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 3,562 | [by-country/ID.txt](by-country/ID.txt) |
| China (CN) | 3,002 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,314 | [by-country/IN.txt](by-country/IN.txt) |
| Japan (JP) | 2,249 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,127 | [by-country/AU.txt](by-country/AU.txt) |
| Hong Kong (HK) | 1,573 | [by-country/HK.txt](by-country/HK.txt) |
| Canada (CA) | 1,556 | [by-country/CA.txt](by-country/CA.txt) |
| France (FR) | 1,408 | [by-country/FR.txt](by-country/FR.txt) |
| South Korea (KR) | 1,398 | [by-country/KR.txt](by-country/KR.txt) |
| Thailand (TH) | 1,256 | [by-country/TH.txt](by-country/TH.txt) |
| South Africa (ZA) | 1,247 | [by-country/ZA.txt](by-country/ZA.txt) |
...
Over 719,313 have been tracked all-time, and 59,575 are live and verified in the working pool right now. The published files hold the proxies confirmed working within the last 48 hours.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-08-31 05:11 UTC</sub></p>
