<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1781961276" alt="HProxy Free Proxy List" width="560"></a>
</p>
...
<p align="center"><b>23,075 free, live-checked proxies, updated every hour.</b><br>HTTP, HTTPS, SOCKS4 and SOCKS5, with country on every IP. 3,220 live right now, 292,234+ tracked all-time, updated 20.06.2026.</p>

## Download

| List | Proxies | Formats |
|------|--------:|---------|
| All | 23,075 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 2,348 | [txt](http.txt) |
| HTTPS | 1,025 | [txt](https.txt) |
| SOCKS4 | 1,268 | [txt](socks4.txt) |
...
|---------|--------:|------|
| Iran (IR) | 6,083 | [by-country/IR.txt](by-country/IR.txt) |
| Indonesia (ID) | 2,487 | [by-country/ID.txt](by-country/ID.txt) |
| United States (US) | 1,629 | [by-country/US.txt](by-country/US.txt) |
| China (CN) | 1,341 | [by-country/CN.txt](by-country/CN.txt) |
...
| South Korea (KR) | 580 | [by-country/KR.txt](by-country/KR.txt) |
...
| France (FR) | 380 | [by-country/FR.txt](by-country/FR.txt) |
| Brazil (BR) | 358 | [by-country/BR.txt](by-country/BR.txt) |
| Singapore (SG) | 345 | [by-country/SG.txt](by-country/SG.txt) |
...
| United Kingdom (GB) | 286 | [by-country/GB.txt](by-country/GB.txt) |
| South Africa (ZA) | 205 | [by-country/ZA.txt](by-country/ZA.txt) |
...
| Ireland (IE) | 142 | [by-country/IE.txt](by-country/IE.txt) |
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; auto-updated hourly &nbsp;&middot;&nbsp; 2026-06-20 13:14 UTC</sub></p>
