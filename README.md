<p align="center">
  <a href="https://hproxy.com"><img src="https://raw.githubusercontent.com/hproxy-com/free-proxy-list/main/assets/banner.svg?v=1788712744" alt="HProxy Free Proxy List" width="560"></a>
</p>

<p align="center">
  <a href="https://hproxy.com"><img src="https://img.shields.io/badge/Website-hproxy.com-0158FF?style=for-the-badge&labelColor=0B1220" alt="Website"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Tracked-766,222-0158FF?style=for-the-badge&labelColor=0B1220" alt="Tracked"></a>
  <a href="https://hproxy.com/free-proxy-list"><img src="https://img.shields.io/badge/Live-61,135-0158FF?style=for-the-badge&labelColor=0B1220" alt="Live"></a>
...
<p align="center"><sub>HTTP, HTTPS, SOCKS4 and SOCKS5 &middot; country, anonymity, latency and uptime on every IP &middot; updated 06.09.2026</sub></p>

HProxy publishes the largest continuously verified list of free public proxies. We aggregate **100+ public sources** every few minutes, test every proxy through **HTTP, HTTPS, SOCKS4 and SOCKS5** around the clock, and enrich each working one with **country, anonymity grade, latency and uptime**. Over **766,222 proxies tracked all-time**, with **6,289** live right now and **61,135** working in the last 48h. Both are published: take `live.txt` if every entry must be up this second, `all.txt` if you want the wider pool that free proxies revive into. It is completely free, updated continuously, and needs no signup and no API key.
...
- **766,222** proxies tracked all-time, **61,135** working in the last 48h
...
|------|--------:|---------|
| **Live now** | 6,289 | [txt](live.txt) &middot; [json](live.json) &middot; [csv](live.csv) |
| **All** (working in 48h) | 61,135 | [txt](all.txt) &middot; [json](all.json) &middot; [csv](all.csv) |
| HTTP | 4,294 | [txt](http.txt) |
| HTTPS | 2,376 | [txt](https.txt) |
| SOCKS4 | 731 | [txt](socks4.txt) |
| SOCKS5 | 514 | [txt](socks5.txt) |
| Elite (high-anonymity) | 3,335 | [txt](elite.txt) |
| Anonymous | 1,966 | [txt](anonymous.txt) |
| Fast (under 2s) | 1,083 | [txt](fast.txt) |
| United States (US) | 16,307 | [txt](by-country/US.txt) &middot; [all &raquo;](by-country) |
...
<details>
<summary><b>Free proxies by country</b> (138 countries)</summary>

| Country | Proxies | File |
|---------|--------:|------|
| United States (US) | 16,307 | [by-country/US.txt](by-country/US.txt) |
| Indonesia (ID) | 4,412 | [by-country/ID.txt](by-country/ID.txt) |
| Japan (JP) | 3,012 | [by-country/JP.txt](by-country/JP.txt) |
| Australia (AU) | 2,743 | [by-country/AU.txt](by-country/AU.txt) |
| China (CN) | 2,730 | [by-country/CN.txt](by-country/CN.txt) |
| India (IN) | 2,501 | [by-country/IN.txt](by-country/IN.txt) |
| Hong Kong (HK) | 2,165 | [by-country/HK.txt](by-country/HK.txt) |
| South Korea (KR) | 1,927 | [by-country/KR.txt](by-country/KR.txt) |
| Canada (CA) | 1,904 | [by-country/CA.txt](by-country/CA.txt) |
| France (FR) | 1,850 | [by-country/FR.txt](by-country/FR.txt) |
| Germany (DE) | 1,685 | [by-country/DE.txt](by-country/DE.txt) |
| Thailand (TH) | 1,674 | [by-country/TH.txt](by-country/TH.txt) |
| _+126 more countries_ | | [full by-country/ folder &raquo;](by-country) |
...
Over 766,222 have been tracked all-time, and 61,135 were working within the last 48h. The published files hold exactly those proxies.
...
<p align="center"><sub><a href="https://hproxy.com">hproxy.com</a> &nbsp;&middot;&nbsp; continuously updated &nbsp;&middot;&nbsp; 2026-09-06 16:39 UTC</sub></p>
